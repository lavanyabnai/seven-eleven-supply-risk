...
// Define icons table first since other tables reference it
...
export const netScenario = pgTable(
  'net_scenario',
  {
    ...
    solutionPool: text('solution_pool'),
...
export type NetScenario = typeof netScenario.$inferSelect;
export type NewNetScenario = typeof netScenario.$inferInsert;
