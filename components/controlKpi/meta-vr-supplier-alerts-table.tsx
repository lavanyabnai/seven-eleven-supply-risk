...
const supplierAlertsData = [
  ...
  },
  {
    ...
    supplierCode: "CMK-002",
    componentType: "Coffee & Hot Beverages",
  ...
  {
    supplierName: "Altria Group / Reynolds American",
    supplierCode: "ALT-004",
    componentType: "Tobacco Products",
    materialCode: "TC-002",
  ...
  },
  {
    ...
    supplierCode: "MDZ-005",
    componentType: "Packaged Snacks & Candy",
    materialCode: "MDZ-001",
    alertType: "Severe OOS",
    affectedSKUs: 3,
  ...
  {
    supplierName: "AB InBev",
    supplierCode: "ABI-006",
    componentType: "Beer & Wine",
    materialCode: "BW-BUD-001",
    alertType: "Critical OOS",
    affectedSKUs: 2,
  ...
  },
  {
    ...
    supplierCode: "MCL-008",
    componentType: "General Merchandise",
    materialCode: "GM-BTC-001",
    alertType: "Severe OOS",
    affectedSKUs: 3,
