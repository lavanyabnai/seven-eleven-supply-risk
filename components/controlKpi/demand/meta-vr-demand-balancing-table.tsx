...
const demandBalancingData = [
  {
    sourceLocation: "7S-DC-VA01",
    materialCode: "7S-COF-001",
    ...
    actionPriority: "High",
    dueDate: "01/18/2025",
    description: "Transfer 5,500 units of 7-Select Hot Coffee Blend 12oz to 7S-DC-TX01 DC to fill projected backorders",
  ...
  {
    sourceLocation: "7S-DC-NC01",
    materialCode: "ED-MON-001",
    ...
    actionPriority: "High",
    dueDate: "01/20/2025",
    description: "Expedite existing stock transfer of Monster Energy Drink 16oz to 7S-DC-AZ01 DC",
  ...
  {
    sourceLocation: "7S-DC-TX01",
    materialCode: "HS-CND-001",
    ...
    actionPriority: "High",
    dueDate: "01/19/2025",
    description: "Transfer Hershey Assorted Candy Pack to 7S-DC-NC01 DC to fill projected backorders",
    alertType: "Stock Shortage",
  ...
  },
  {
    ...
    dueDate: "01/22/2025",
    description: "Transfer Hershey Assorted Candy Pack to 7S-DC-GA01 DC to fill projected backorders",
    alertType: "Low Stock",
  ...
  },
  {
    ...
    actionPriority: "High",
    dueDate: "01/21/2025",
    description: "Expedite existing stock transfer of 7-Select Hot Coffee Blend 12oz to 7S-DC-VA01 DC",
    alertType: "Stock Shortage",
  ...
  },
  {
    ...
    actionPriority: "Medium",
    dueDate: "01/25/2025",
    description: "Transfer Altria Marlboro Cigarettes Carton to 7S-DC-VA01 DC to fill projected backorders",
  ...
  },
  {
    ...
    actionPriority: "High",
    dueDate: "01/23/2025",
    description: "Request expedited replenishment of Monster Energy Drink 16oz to fill projected backorders",
    alertType: "Critical Shortage",
  ...
  },
  {
    ...
    actionPriority: "Medium",
    dueDate: "01/24/2025",
    description: "Transfer 7-Select Hot Coffee Blend 12oz to 7S-DC-NC01 DC to fill projected backorders",
    alertType: "Low Stock",
          ...
          <TableBody>
            {demandBalancingData.map((item, index) => (
              <TableRow key={index} className="hover:bg-muted/50 cursor-pointer">
                <Link
                  href={`/risk/controlTower/demand-balancing/${encodeURIComponent(item.sourceLocation)}-${encodeURIComponent(item.materialCode)}-${index}`}
                  className="contents"
                >
