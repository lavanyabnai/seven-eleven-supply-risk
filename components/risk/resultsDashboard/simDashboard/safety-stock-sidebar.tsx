...
interface SafetyStockSidebarProps {
  activeView: string
  onViewChange: (view: string) => void
}

export default function SafetyStockSidebar({ activeView, onViewChange }: SafetyStockSidebarProps) {
  const menuItems = [
    { id: "overview", label: "Overview" },
    { id: "service-level-analysis", label: "Service Level Analysis" },
    { id: "demand-variability", label: "Demand Variability" },
    { id: "lead-time-analysis", label: "Lead Time Analysis" },
    { id: "stockout-probability", label: "Stockout Probability" },
