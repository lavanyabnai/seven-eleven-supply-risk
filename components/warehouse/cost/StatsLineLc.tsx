...
const chartData = [
  ...
  { month: "Q3'24", desktop: 41, mobile: 10 },
  { month: "Q4'24", desktop: 40, mobile: 11 },
  { month: "Q1'25", desktop: 39, mobile: 12 },
...
export default function StatsLineLc() {
          ...
          ></span>
            ...
            <div className="my-2 flex items-baseline gap-2 ">
              ...
              <div>
                ...
                Labor Cost as % of Total Warehousing Cost
                </h2>
