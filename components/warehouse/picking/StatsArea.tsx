          ...
          ></span>
            ...
            <div className="my-2 flex items-baseline gap-2 ">
              ...
              <div>
                ...
                Average Travel Distance Per Pick <span className="text-sm text-gray-500">(Meters)</span>
                </h2>
      ...
      <Progress value={kpi.TargetAch}  indicatorColor={`${ kpi.TargetAch > 50? "bg-green-400" : "bg-red-400"}`}  className="ml-auto h-2 w-[50%]" />
          ...
          <div className="grid gap-2">
            <div className="flex items-center gap-2 font-medium">
              Zone picking reduced travel by 25% vs single order picking <TrendingUp className="h-4 w-4" />
            </div>
