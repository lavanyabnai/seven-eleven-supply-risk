...
const chartData = [
  ...
  { month: "Wed", desktop: 97.5, mobile: 95.2, tv: 98.4 },
  { month: "Thu", desktop: 95.9, mobile: 92.1, tv: 97.0 },
  { month: "Fri", desktop: 96.1, mobile: 91.5, tv: 96.8 },
  { month: "Sat", desktop: 97.8, mobile: 95.8, tv: 98.6 },
]
const chartConfig = {
  desktop: {
      ...
      <CardFooter>
        <div className="grid gap-2 text-sm">
          <div className="flex items-center gap-2 font-medium">
            Direct-to-jobsite OTIF dips on Fridays — fleet capacity constraint
          </div>
