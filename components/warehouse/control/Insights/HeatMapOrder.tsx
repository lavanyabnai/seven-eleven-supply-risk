...
const data = [
  {
    name: "axis",
    children: [
      { name: "Front Royal VA", size: 4800, fill: '#3b82f6' },
      { name: "Houston MDC", size: 5200, fill: '#10b981' },
      { name: "Dallas MDC", size: 4900, fill: '#f59e0b' },
      { name: "Nashville MDC", size: 4500, fill: '#8b5cf6' },
      { name: "Stockton CA", size: 4200, fill: '#ef4444' },
    ],
  },
