  ...
  const demandBalancingData = [
    {
      ...
      actionPriority: "High",
      dueDate: "04/22/2026",
      description: "Transfer 5,500 units of 7-Select Hot Coffee Blend to 7S-DC-TX01 to fill projected backorders",
    ...
    {
      sourceLocation: "7S-DC-CA01",
      materialCode: "7S-SNK-001",
      ...
      actionPriority: "High",
      dueDate: "04/25/2026",
      description: "Expedite import shipment of 7-Select Snacks from Core-Mark DC - Westlake TX to 7S-DC-SB01 — supply delay",
    ...
    {
      sourceLocation: "7S-DC-IL01",
      materialCode: "7S-COF-002",
      ...
      dueDate: "04/28/2026",
      description: "Transfer Coffee & Hot Beverages from Chicago DC to Denver DC for seasonal demand surge",
    ...
    },
    {
      ...
      dueDate: "04/20/2026",
      description: "Tobacco leaf shortage at Altria — expedite alternate supply from Reynolds American Greensboro",
