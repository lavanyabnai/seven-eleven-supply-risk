...
export const ImportCard = ({ data, onCancel, onSubmit }: Props) => {
  ...
  const handleContinue = () => {
    ...
    const formattedData = arrayOfData.map((item) => ({
     ...
     costCalculationPolicy: item.costCalculationPolicy,
    //  costPuPk: Number(item.costPuPk),
    ...
    //  transportationPolicy: item.transportationPolicy,
    //  minLoadRatio: item.minLoadRatio,
